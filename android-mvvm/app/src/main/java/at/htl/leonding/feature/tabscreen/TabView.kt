...
import at.htl.leonding.feature.example.RxJavaView
...
class TabView @Inject constructor() {
    ...
    @Inject
    lateinit var rxJavaView: RxJavaView
    ...
    fun TabViewLayout() {
        ...
        val tabs = listOf("Home", "ToDos", "Examples", "Settings")
