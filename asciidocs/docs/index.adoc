...
- **Abhängigkeits-Tracking:** Sie verfolgen automatisch Abhängigkeiten, sodass Änderungen an einem Signal alle
abhängigen Komponenten oder Berechnungen automatisch aktualisieren.
...
- https://vertx.io/
- reahttps://www.betterask.erni/introduction-to-angular-signals/